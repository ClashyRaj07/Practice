                                            ...
                                            <div className="flex flex-col justify-center  my-10 w-[95%] space-y-28 lg:space-y-24 max-w-7xl">
                                                <div className="flex flex-col justify-center items-center ">
                                                    ...
                                                    <div className="border-b-4 border-[#20b486] mt-2"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;</div>
                                                    <div className="text-black text-sm text-center mt-5">Subscribe Practice to find more
                                                        Courses
                                                    </div>
                                                </div>
                                                <div className="flex flex-col justify-center items-center lg:flex-row space-y-28 lg:space-y-0  lg:space-x-10">
                                                    <div
                                                        ...
                                                        <div className="flex flex-col lg:flex-row justify-center text-center lg:space-x-3">
                                                            <h1 className="text-[#20b486] text-lg font-semibold">Antonio Starc</h1>
                                                    ...
                                                    <div
                                                        ...
                                                        <p className="text-center text-sm p-5">Tailblockss provides best Tailwind CSS Components and Blocks to
                                                            create an unique websites within minutes.</p>
                                                        <div className="flex flex-col lg:flex-row justify-center text-center lg:space-x-3">
                                                            <h1 className="text-[#20b486] text-lg font-semibold">Maria Starc</h1>
                                                            <p className="text-black text-sm lg:mt-[5px]">Co-Founder at xyz</p>
                                                        </div>
                                                    </div>
                                                    <div
                                                        ...
                                                        <p className="text-center text-sm p-5">Tailblockss provides best Tailwind CSS Components and Blocks to
                                                            create an unique websites within minutes.</p>
                                                        <div className="flex flex-col lg:flex-row justify-center text-center lg:space-x-3">
                                                            <h1 className="text-[#20b486] text-lg font-semibold">Jessica Starc</h1>
                                                            <p className="text-black text-sm lg:mt-[5px]">Co-Founder at xyz</p>
                                                        </div>
                                                    </div>
